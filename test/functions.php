...
class FunctionsTest extends TestCase {
    public function testDisplayFilms() {
        ...
        $expectedResult = '<div class="film-card"><div class="film-detail-box"><h3>A Few Good Men</h3><p>Year released: 1992</p><p>Star review: 4</p><p>Bechdel test: FAIL</p></div><form method="post" action="delete-from-database.php"><input type="submit" value="Delete" name="1"></form></div><div class="film-card"><div class="film-detail-box"><h3>Stand By Me</h3><p>Year released: 1986</p><p>Star review: 5</p><p>Bechdel test: FAIL</p></div><form method="post" action="delete-from-database.php"><input type="submit" value="Delete" name="2"></form></div>';
